...
Public Class CariBarangPembelian
    ...
    Public Sub Data_Record()
        barang = Proses.ExecuteQuery("SELECT ID_BARANG, NAMA_BARANG, HARGA_BELI, STOK_BARANG FROM barang")
    ...
    Private Sub CariBarangPembelian_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Call Data_Record()
        Rb_IDbrg.Checked = True
        TextBrg.Visible = False
        TextKodeBrg.Visible = False
        TxtHrgBeli.Visible = False
    ...
    Private Sub DGCariBarang_CellClick(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles DGCariBarang.CellClick
        ...
        With DGCariBarang
            ...
            Pembelian.TextKodeBrg.Text = TextKodeBrg.Text
            Pembelian.TextBrgBeli.Text = TextBrg.Text
            Pembelian.TextHargaBeli.Text = TxtHrgBeli.Text
            Pembelian.TextHrgBrgVisible.Text = TxtHrgBeli.Text
            Pembelian.TextStokBrg.Text = TxtStok.Text
            Pembelian.TextQTYBeli.Text = 1
            MenuUtama.TampilForm(Pembelian)
            Me.Close()
            Pembelian.TextQTYBeli.Focus()
        End With
    End Sub
    ...
    Private Sub CariBarangPembelian_MouseDown(ByVal sender As Object, ByVal e As System.Windows.Forms.MouseEventArgs) Handles Me.MouseDown
        Me.Capture = False
