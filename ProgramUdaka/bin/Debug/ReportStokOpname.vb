...
Public Class ReportStokOpname
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ProgramUdaka.ReportStokOpname.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReportStokOpname
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ReportStokOpname = New ReportStokOpname()
        rpt.Site = Me.Site
        Return rpt
    End Function
