...
Public Class ReportPendapatan
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ProgramUdaka.ReportPendapatan.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReportPendapatan
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ReportPendapatan = New ReportPendapatan()
        rpt.Site = Me.Site
        Return rpt
    End Function
