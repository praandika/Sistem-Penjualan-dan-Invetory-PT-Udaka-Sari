...
Public Class CariBarangPenjualan
    ...
    Public Sub Data_Record()
        barang = Proses.ExecuteQuery("SELECT ID_BARANG, NAMA_BARANG, HARGA_JUAL, STOK_BARANG FROM barang")
        ...
        DGCariBarang.Columns(2).DefaultCellStyle.Format = "###,###,###"
        DGCariBarang.Columns(3).Width = 100
    End Sub

    Private Sub CariBarangPenjualan_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Call Data_Record()
        Rb_IDbrg.Checked = True
        TextBrg.Visible = False
        TextKodeBrg.Visible = False
        TxtHrgJual.Visible = False
    ...
    Private Sub DGCariBarang_CellClick(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles DGCariBarang.CellClick
        ...
        With DGCariBarang
            ...
            TxtHrgJual.Text = .Item(2, baris).Value
            TxtStok.Text = .Item(3, baris).Value
            Penjualan.TextIDbrg.Text = TextKodeBrg.Text
            Penjualan.TextBrgJual.Text = TextBrg.Text
            Penjualan.TextHarga.Text = TxtHrgJual.Text
            Penjualan.TextHrgBrgVisible.Text = TxtHrgJual.Text
            Penjualan.TextStok.Text = TxtStok.Text
            Penjualan.TextQTY.Text = 1
            MenuUtama.TampilForm(Penjualan)
            Me.Close()
            Penjualan.TextQTY.Focus()
        End With
    End Sub
    ...
    Private Sub CariBarangPenjualan_MouseDown(ByVal sender As Object, ByVal e As System.Windows.Forms.MouseEventArgs) Handles Me.MouseDown
        Me.Capture = False
